                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide slide-content d-flex align-items-center">
                                <div class="single-slide">
                                    <h1 data-aos="fade-right" data-aos-delay="200">Personal Information<br/> 
                                    </h1>
                                    <p data-aos="fade-right"  data-aos-delay="600"><h3>Rady AL Abdulrahman Sulaiman</h3> <br/> 
                                    Buraydah <br/> Sciences Administrative University 
                                    </p>
    ...
    <section class="services">
        <div class="container">
            <div class="title text-center">
                <h6>Our Speakers</h6>
                <h1 class="title-blue">Scientific Expertise</h1>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                            ...
                            <div class="media-body">
                                ...
                                -Working with Father in food trade from 1405 AH until 1410 AH.<br/>
                               -Management of a distribution company for toys and sweets from 1410 AH to 1413 AH.<br/>
                               -Foundation Management of feeding and nutrition in schools.
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="400" data-aos-duration="600">
                            ...
                            <div class="media-body">
                                ...
                                -Foundation Management In cleanliness and maintenance from 1414 AH to 1417 AH.<br/>
                                -Foundation Management In the contracting  and operation projects from 1417 AH to 1421 AH.<br/>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="600" data-aos-duration="800">
                            ...
                            <div class="media-body">
                                ...
                                -Management of three foundations in operation maintenance catering and supplies from 1421 AH to 1425 AH.<br/>
                                -Management of three companies operating in the operation maintenance subsistence and import of cattle and land and sea transport from 1425 AH to 1433 AH.<br/>
                                -Management and ownership of 94% of Ibrahim Sulaiman AL Rady Trading and Contracting Company and classified as a third class maintenance and classified in ten other fields.  
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                            ...
                            <div class="media-body">
                                {/* <h5>Modern style</h5> */}
                                {/* Donec volutpat tincidunt neque, vitae lobortis libero mattis sed tempus. */}
                                -Management and ownership of 40% of the Saudi Operating Company with a Capital of 300 million riyals.<br/>
                                -The Management of the United Company for Land and the Navy Lines which has a ships working between Egypt and Saudi Arabia.
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="400" data-aos-duration="600">
                            ...
                            <div class="media-body">
                                {/* <h5>Web Development</h5> */}
                                {/* Donec volutpat tincidunt neque, vitae lobortis libero mattis sed tempus. */}
                                -Partner in Al Masar Distinctive International Transport Company operating in Saudi Arabia.<br/>
                                -Partner in Firas Abdulrahman AL Rady Trading & Contracting Est.<br/>
                                -Partner in Sadam AbdulKarim AL Rady Trading Est.
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-4">
                        <div class="media" data-aos="fade-up" data-aos-delay="600" data-aos-duration="800">
                            ...
                            <div class="media-body">
                                ...
                                {/* Donec volutpat tincidunt neque, vitae lobortis libero mattis sed tempus. */}
                                -Partner in Mohammed Sulaiman Al Rumaih Foundation.<br/>
                                -Management and operation of the Russian factory for marble reservation in Buraydah (Interlock)
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6" data-aos="fade-right" data-aos-delay="400" data-aos-duration="800">
                    <div class="title">
                        ...
                        <h1 class="title-blue">Speech of the Chairman.</h1>
                    </div>
                    <p>Since the establishment of Ibrahim Sulaiman Al Radi The company has been able to find values and concepts in the fields of business 
                    management and has taken over the past decade a lot of bold steps and invested in many areas of business that modern thinking and creativity and innovation is one of the foundations on
                    which the company built credibility is the fundamental principle governing the work of the company is the common denominator that we can From consistently adhering to our promise to our customers partners and employees
                    <br/>
                    As a family company with diversified investments our strength is a result of the ever-expanding scope of our industrial and commerical activities,which we manage through various
                    fields such as construction contracting general trading supported by financial and administrative experience
                    </p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-right"
                        ...
                        <div class="post-content text-sm-right">
                            ...
                            <h3><a href="#">General Contracting</a></h3>
                ...
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-right" data-aos-delay="200"
                        ...
                        <div class="post-content text-sm-right">
                            {/* <time datetime="2019-04-06T13:53">15 Oct, 2019</time> */}
                            <h3><a href="#">Agriculture & Coordination Gardens</a></h3>
                            {/* <p><a href="#">Seanding</a>, <a href="#">Website</a>, <a href="#">E-commerce</a></p> */}
                            <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>
                        </div>
                        <div class="post-thumb">
                ...
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-delay="200"
                        ...
                        <div class="post-content">
                            {/* <time datetime="2019-04-06T13:53">15 Oct, 2019</time> */}
                            <h3><a href="#">Electromechanical works</a></h3>
                            {/* <p><a href="#">Seanding</a>, <a href="#">Website</a>, <a href="#">E-commerce</a></p> */}
                            <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="single-rpost d-sm-flex align-items-center" data-aos="fade-left" data-aos-delay="200"
                        ...
                        <div class="post-content">
                            {/* <time datetime="2019-04-06T13:53">15 Oct, 2019</time> */}
                            <h3><a href="#">Transport and shipping works</a></h3>
                            {/* <p><a href="#">Seanding</a>, <a href="#">Website</a>, <a href="#">E-commerce</a></p> */}
                            <a class="post-btn" href="#"><i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
